...
class ContentType(Entity):
    ...
    model = TextProperty(max_length=100, verbose_name=_('python model class name'), unique_with='app_label')
...
class User(Document):
    ...
    last_login = DateTimeField(default=datetime_now, verbose_name=_('last login'))
    date_joined = DateTimeField(default=datetime_now, verbose_name=_('date joined'))
